            ...
            <div className='main-body'>
                ...
                <div className='container p-3'>
                    <form onSubmit={handleSubmit}>
                        ...
                        {/* Screenshot Image */}
                        <div className="mb-3">
                            <label htmlFor="screenshot" className="form-label">Screenshot Image</label>
                            <input
                                type="file"
                                name="screenshot"
                                className="form-control"
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                            />
                            <div className="form-text">Please ensure the features are comma-separated.</div>
                        </div>
                        ...
                        <div className="mb-3 form-check">
                            <input
                                ...
                                onChange={() => setFormData((prev) => ({ ...prev, status: prev.status === 'Active' ? 'Inactive' : 'Active' }))}
                            />
